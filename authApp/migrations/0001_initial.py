...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Checkout',
            fields=[
                ('no_checkout', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
                ('fecha_salida', models.DateTimeField(default=datetime.datetime(2022, 5, 1, 19, 56, 3, 468156, tzinfo=utc))),
            ],
        ),
        migrations.CreateModel(
            name='Cliente',
        ...
        migrations.CreateModel(
            name='Factura',
            fields=[
                ('no_factura', models.CharField(max_length=6, primary_key=True, serialize=False, unique=True)),
                ('fecha_factura', models.DateTimeField(default=datetime.datetime(2022, 5, 1, 19, 56, 3, 470155, tzinfo=utc))),
        ...
        migrations.CreateModel(
            name='Reserva',
            fields=[
                ('no_reserva', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authApp.tipohabitacion')),
            ],
        ),
        migrations.AddField(
            model_name='factura',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reserva', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authApp.reserva')),
            ],
        ),
        migrations.CreateModel(
